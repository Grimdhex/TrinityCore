...
{
    public:
        constexpr explicit WorldLocation()
            : m_mapId(MAPID_INVALID) { }

        constexpr explicit WorldLocation(uint32 _mapId, float x, float y, float z = 0.0f, float o = 0.0f)
...
struct TaggedPosition
{
    ...
    constexpr TaggedPosition(float x, float y, float z = 0.0f, float o = 0.0f) : Pos(x, y, z, o) { }
